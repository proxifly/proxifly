...
### Getting an API key
You can use so much of `proxifly` for free, but if you want to do some advanced stuff, you'll need an API key. You can get one by [signing up for an account](https://proxifly.com/authentication/signup).
